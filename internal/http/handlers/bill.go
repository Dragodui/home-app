...
// @Security     BearerAuth
// @Param        home_id      path   int  true   "Home ID"
// @Param        category_id  query  int  false  "Filter by bill category ID"
// @Success      200  {object}  models.BillListResponse  "Private bills list"
// @Failure      400  {object}  models.ErrorResponse     "Invalid home_id or category_id"
// @Failure      401  {object}  models.ErrorResponse     "Missing or invalid authentication"
// @Failure      403  {object}  models.ErrorResponse     "User is not a member of the home"
// @Failure      500  {object}  models.ErrorResponse     "Failed to retrieve bills"

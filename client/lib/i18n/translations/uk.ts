export default {
  ...
  verify: {
    ...
    checkInbox:
      "Ми надіслали посилання для підтвердження на {email}. Перевірте свою поштову скриньку та натисніть посилання для підтвердження.",
  ...
  tasks: {
    ...
    reminderBefore: "Нагадування до терміну (хвилини)",
    reminderMinutesSuffix: "хв до",
    reminderAtDue: "У момент терміну",
  ...
  profile: {
    ...
    memberProfileSelectHome: "Спочатку виберіть дім",
    memberProfileNotFound: "Учасника не знайдено",
    memberProfileUnknown: "Невідомо",
    memberProfileRole: "Роль",
    memberProfileJoined: "Приєднався",
    memberProfileStatsVisibility: "Видимість статистики",
    memberProfileHiddenFromMembers: "Приховано від інших учасників",
    memberProfileVisibleToMembers: "Видимо для інших учасників",
    memberProfileStatsHidden: "Цей учасник приховав свою статистику.",
    memberProfileTaskStats: "Статистика завдань",
    memberProfileBudgetStats: "Статистика бюджету",
    memberProfileBillsCreated: "Створені рахунки",

export default {
  ...
  verify: {
    ...
    checkInbox:
      "Мы адправілі спасылку для пацвярджэння на {email}. Праверце сваю паштовую скрынку і націсніце спасылку для пацвярджэння.",
  ...
  tasks: {
    ...
    noReminder: "Без напаміну",
    reminderLabel: "Напамін",
    reminderBefore: "Напамін да тэрміну (хвіліны)",
    reminderMinutesSuffix: "хв да",
    reminderAtDue: "У момант тэрміну",
  ...
  profile: {
    ...
    memberProfileSelectHome: "Спачатку выберыце дом",
    memberProfileNotFound: "Удзельнік не знойдзены",
    memberProfileUnknown: "Невядома",
    memberProfileRole: "Роля",
    memberProfileJoined: "Далучыўся",
    memberProfileStatsVisibility: "Бачнасць статыстыкі",
    memberProfileHiddenFromMembers: "Схавана ад іншых удзельнікаў",
    memberProfileVisibleToMembers: "Бачна іншым удзельнікам",
    memberProfileStatsHidden: "Гэты ўдзельнік схаваў сваю статыстыку.",
    memberProfileTaskStats: "Статыстыка задач",
    memberProfileBudgetStats: "Статыстыка бюджэту",
    memberProfileBillsCreated: "Створаныя рахункі",
    memberProfileAssignedSplitAmount: "Прызначаная сума падзелу",
    memberProfileLoadFailed: "Не ўдалося загрузіць профіль удзельніка",
    memberProfileVisibilityFailed: "Не ўдалося абнавіць бачнасць",
  },
